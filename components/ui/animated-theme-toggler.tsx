...
interface AnimatedThemeTogglerProps extends React.ComponentPropsWithoutRef<"button"> {
   ...
   * (e.g. our SiteThemeProvider) and this component will not touch
   * `<html>`'s class or localStorage itself.
   */
  theme?: "light" | "dark"
...
export const AnimatedThemeToggler = ({
  ...
  const toggleTheme = useCallback(() => {
    ...
    const applyTheme = () => {
      ...
      if (isControlled) {
        // The parent (our SiteThemeProvider) owns the actual class + storage
        // — it scopes "light"/"dark" to a subtree instead of <html>, so this
        // never touches document.documentElement directly.
