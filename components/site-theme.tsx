...
// and the board editor's canvas — rather than the whole app: the sign-in
// screen is a fixed black splash, and the editor's toolbar/top bar,
// Component Library, properties panel, zoom controls, and theme-toggle pill
// are all permanently dark tool chrome, like Figma's, not meant to flip (each
// pins itself back to dark with its own "dark" class; see
// component-library.tsx, properties-panel.tsx, zoom-controls.tsx, and
// board-editor.tsx). Both places share the same localStorage key, so the
